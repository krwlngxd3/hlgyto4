...
var kanal = "915231652005965825"; // MESAJLARIN GONDERILECEĞI KANAL ID BURAYA
var sahip = "882851502304161873"; // KENDI ID'NIZ BURAYA
...
setInterval(function(){
	if(db.get("owodg") != "1"){
		client.channels.get(kanal).send("owoh");
...
setInterval(function(){
	if(db.get("owodg") != "1"){
		client.channels.get(kanal).send("owob");
...
client.login("ODgyODUxNTAyMzA0MTYxODcz.YakT3w.2D2UvPICcxf6htqrHv7Tcu8NYEA"); // HESAP TOKENI BURAYA